...
<div className="navbar max-w-7xl mx-auto py-3 md:px-6 px-3">
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <NavLink to='/' className={({ isActive }) => isActive ? 'text-[#FF8033] px-4 py-2 font-bold rounded-lg ' : 'font-semibold text-[#FF8033]'}>Home</NavLink>
       <NavLink to='/allSpot' className={({ isActive }) => isActive ? 'text-[#FF8033] px-4 py-2 font-bold rounded-lg ' : 'font-semibold text-[#FF8033]'}>All Foods</NavLink>
      </ul>
    </div>
  ...
  <div className="navbar-center hidden lg:flex">
    ...
    <NavLink to='/allSpot' className={({ isActive }) => isActive ? 'text-[#FF8033] px-4 py-2 font-bold rounded-lg border border-[#C04619]  ' : 'font-semibold text-[#FF8033]'}>All Foods</NavLink>
     </div>
    </ul>
  </div>
